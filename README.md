...
1. Clone this repository and enter the new directory:
    ...
    ```bash
    git clone https://github.com/DouweM/tidbyt-common-misconceptions.git
    cd tidbyt-common-misconceptions
    ```
...
The image will be created at `output/common-misconceptions/<timestamp>.webp`.
